  ...
  <section class="py-12 px-4 sm:px-6 lg:px-8 bg-surface-variant dark:bg-surface-variant-dark">
    <div class="max-w-7xl mx-auto">
      <div class="flex justify-between items-center mb-8">
        <h2 class="text-2xl font-bold text-on-surface-variant dark:text-on-surface-variant-dark">
          {{ title }}
        </h2>
        <NuxtLinkLocale to="/projects" class="inline-flex items-center text-primary dark:text-primary-dark hover:underline">
